...
var elms = ['track', 'timer', 'duration', 'playBtn', 'pauseBtn', 'prevBtn', 'nextBtn', 'playlistBtn', 'volumeBtn', 'progress', 'bar', 'wave', 'loading', 'scrubber', 'playlist', 'list', 'volume', 'barEmpty', 'barFull', 'sliderBtn'];
...
var Player = function(playlist) {
  ...
  //   var listThumb = document.createElement('div');
  //   var listHead = document.createElement('div');
  //
  //   listSong.className = 'list-song';
  //   listThumb.className = 'list-thumb';
  //
  //   listSong.appendChild(listThumb);
  //   listThumb.appendChild(listHead);
  //   listHead.innerHTML = audio.title;
  //   // listSong.innerHTML = audio.title;
